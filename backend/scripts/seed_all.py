...
COURSES = [
    dict(name="Dicoding — Menjadi Go Developer", provider="Dicoding",
         category="tech", skills_taught=["Go", "gRPC", "API", "Microservices"],
         duration="2 bulan", cost_idr=500_000, is_prakerja=True, level="intermediate",
         description="Kelas pemrograman Go terakreditasi industri untuk merancang REST API & backend andal."),
    dict(name="Dicoding — Belajar Membuat Aplikasi Web dengan React", provider="Dicoding",
         category="tech", skills_taught=["React", "JavaScript", "HTML", "CSS", "Next.js"],
    ...
    dict(name="Dicoding — Menjadi Cloud dan DevOps Engineer", provider="Dicoding",
         category="tech", skills_taught=["Docker", "Kubernetes", "AWS", "Terraform", "DevOps"],
         duration="2 bulan", cost_idr=600_000, is_prakerja=True, level="intermediate",
         description="Kuasai infrastruktur modern, container orchestration, CI/CD, dan cloud AWS."),
    dict(name="Dicoding — Belajar Dasar Structured Query Language (SQL)", provider="Dicoding",
         category="tech", skills_taught=["SQL", "PostgreSQL", "Database"],
         duration="3 minggu", cost_idr=250_000, is_prakerja=True, level="beginner",
    ...
    dict(name="Dicoding — Belajar Machine Learning untuk Pemula", provider="Dicoding",
         category="tech", skills_taught=["Python", "Machine Learning", "Statistika", "TensorFlow"],
    ...
    dict(name="Dicoding — Belajar Membuat Aplikasi Android untuk Pemula", provider="Dicoding",
    ...
    dict(name="Dicoding — Belajar Dasar-Dasar UI/UX Design", provider="Dicoding",
         category="tech", skills_taught=["Figma", "Design", "Design System", "User Research"],
         duration="1 bulan", cost_idr=300_000, is_prakerja=True, level="beginner",
         description="Dasar rancang bangun antarmuka digital interaktif dan pengujian usability."),
    dict(name="Dicoding — Belajar Pemrograman Python", provider="Dicoding",
         category="tech", skills_taught=["Python", "Git", "Programming"],
         duration="1 bulan", cost_idr=250_000, is_prakerja=True, level="beginner",
         description="Pelajari bahasa paling populer untuk data science, otomasi, dan web backend."),
    dict(name="Dicoding — Belajar Menggunakan Redis & Event Streaming", provider="Dicoding",
         category="tech", skills_taught=["Redis", "Kafka", "Caching"],
         duration="3 minggu", cost_idr=350_000, is_prakerja=True, level="intermediate",
         description="Optimasi skalabilitas aplikasi menggunakan Redis caching & Kafka event messaging."),
    dict(name="Dicoding — Belajar Fundamental Front-End Web Development", provider="Dicoding",
         category="tech", skills_taught=["JavaScript", "Tailwind CSS", "HTML", "CSS"],
         duration="1 bulan", cost_idr=350_000, is_prakerja=True, level="beginner",
